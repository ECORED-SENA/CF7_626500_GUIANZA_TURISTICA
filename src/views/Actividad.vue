  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Pongamos a prueba qué tanto hemos aprendido
        p.mb-4 Apropiar conceptos para la construcción del plan interpretativo del servicio guiado.
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Marcar la respuesta correcta.
            .col-auto
